...
class Net(nn.Module):
    ...
    def __init__(self, input_size=3, hidden_size_1=128, hidden_size_2=64, hidden_size_3=32, hidden_size_4=16, output_size=2):
...
class TimeSeriesDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, csv_file):
        ...
        self.t = torch.concat([self.t.reshape(-1,1), self.mask], dim=1)
...
plt.legend()
plt.savefig("figure/2_all_shared+mask.png")
