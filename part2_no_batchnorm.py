...
class Net(nn.Module):
    ...
    def __init__(self, input_size=1, hidden_size_1=128, hidden_size_2=64, hidden_size_3=16, output_size=1):
    ...
    def forward(self, x):
        ...
        x_1 = F.relu(self.seperated_layer1_x(x))
        y_1 = F.relu(self.seperated_layer1_y(x))
...
plt.legend()
plt.savefig("figure/2_no_batchnorm.png")
